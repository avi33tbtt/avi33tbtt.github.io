...
// DISEASES: Subject -> Chapter number -> { title, common[], lessCommon[], rare[] }
// Powers the 4th selection layer (Subject -> Chapter -> Topic -> Disease)
// and the {{DISEASE}} token in prompts-data.js.
const DISEASES = {
 "Anatomy": {
  1: {
   title: "General Anatomy — Terminology, Planes, and Body Organization",
  ...
  2: {
   title: "Gross Anatomy of the Upper Limb",
   common: [],
   lessCommon: ["Sprengel's deformity"],
   rare: [],
  },
  3: {
   title: "Gross Anatomy of the Lower Limb",
   common: ["Varicose veins", "Flat foot (pes planus)"],
   lessCommon: [],
   rare: [],
  },
  4: {
   title: "Gross Anatomy of the Thorax",
   common: [],
   lessCommon: ["Coarctation of aorta (anatomical basis)"],
   rare: [],
  },
  5: {
   title: "Gross Anatomy of the Abdomen and Pelvis",
   common: ["Inguinal hernia (indirect/direct)"],
   lessCommon: ["Polycystic kidney (anatomical correlation)", "Double ureter / duplex collecting system"],
   rare: [],
  },
  6: {
   title: "Gross Anatomy of the Head and Neck",
   common: ["Cervical rib"],
   lessCommon: ["Klippel-Feil syndrome"],
   rare: [],
  },
  7: {
   title: "Neuroanatomy — Central and Peripheral Nervous System",
   common: [],
   lessCommon: [],
   rare: ["Agenesis of corpus callosum"],
  },
  8: {
   title: "Histology — Epithelial, Connective, Muscle, and Nerve Tissues",
   common: [],
  ...
  9: {
   title: "Embryology — Early Development and Organogenesis",
   common: ["Bicornuate uterus / uterine anomalies", "Meckel's diverticulum", "Cleft lip and palate", "Undescended testis (cryptorchidism)", "Spina bifida occulta", "Accessory/supernumerary breast (polymastia)"],
   lessCommon: ["Situs inversus", "Horseshoe kidney", "Congenital diaphragmatic hernia", "Persistent Mullerian duct syndrome", "Amelia / phocomelia (limb anomalies)"],
   rare: ["Situs ambiguus", "Ectopia cordis", "Conjoined twins (anatomical basis)", "Sirenomelia", "Cyclopia", "Rachischisis", "Persistent truncus arteriosus (anatomical)", "Dextrocardia with situs solitus", "Polydactyly/syndactyly complex variants"],
  },
  10: {
   title: "Surface and Radiological Anatomy",
   common: [],
 ...
 "Physiology": {
  1: {
   title: "General Physiology — Cell, Body Fluids, and Homeostasis",
   common: ["Dehydration / fluid imbalance", "Heat exhaustion"],
   lessCommon: [],
   rare: [],
  },
  2: {
   title: "Blood and Lymph — Composition, Haemopoiesis, Haemostasis",
   common: ["Anemia (physiological classification)"],
   lessCommon: [],
   rare: [],
  },
  3: {
   title: "Cardiovascular System — Cardiac Cycle, Heart Sounds, ECG",
   common: ["Hypertension (physiological basis)", "Vasovagal syncope"],
   lessCommon: ["Postural orthostatic tachycardia syndrome (POTS)"],
   rare: ["Brugada syndrome (channelopathy)", "Long QT syndrome", "Catecholaminergic polymorphic VT"],
  },
  4: {
   title: "Respiratory System — Mechanics of Breathing, Gas Exchange",
   common: ["Hypoxia (types)", "Altitude sickness (hypoxia adaptation)"],
   lessCommon: ["Decompression sickness", "Chronic mountain sickness", "Ondine's curse (central hypoventilation)", "Exercise-induced bronchospasm"],
   rare: [],
  },
  5: {
   title: "Digestive System — Secretion, Motility, Absorption",
  ...
  7: {
   title: "Nervous System — Neurophysiology, Reflexes, Special Senses",
   common: ["Jet lag / circadian rhythm disturbance"],
   lessCommon: ["Reflex sympathetic dystrophy"],
   rare: ["Congenital insensitivity to pain", "Guillain-Barré related autonomic dysfunction", "Central pontine myelinolysis (physiological correlate)", "Batten disease (metabolic/physiological)", "Familial dysautonomia (Riley-Day syndrome)"],
  },
  8: {
   title: "Endocrine System — Hormones and Regulation",
   common: [],
   lessCommon: ["Diabetes insipidus (physiological)", "SIADH (physiological)"],
   rare: ["Primary hyperaldosteronism (physiological)"],
  },
  9: {
   title: "Reproductive Physiology — Male and Female",
   common: ["Menstrual irregularities (physiological)"],
   lessCommon: [],
   rare: [],
  },
  10: {
   title: "Muscle Physiology — Skeletal, Cardiac, and Smooth Muscle",
   common: ["Fatigue/muscle cramps (electrolyte-related)"],
   lessCommon: ["Familial periodic paralysis", "Malignant hyperthermia"],
   rare: ["Andersen-Tawil syndrome"],
  },
 },
 "Biochemistry": {
  1: {
   ...
   common: [],
   lessCommon: [],
   rare: ["Hurler syndrome (mucopolysaccharidosis)"],
  },
  2: {
   title: "Enzymes — Structure, Kinetics, and Regulation",
   common: [],
  ...
  3: {
   title: "Carbohydrate Metabolism — Glycolysis, TCA Cycle, Gluconeogenesis",
   common: ["Diabetes mellitus (Type 1 & 2)", "Metabolic syndrome"],
   lessCommon: ["G6PD deficiency", "Galactosemia", "Lactose intolerance", "Glycogen storage diseases (von Gierke's, Pompe's)"],
   rare: [],
  },
  4: {
   title: "Lipid Metabolism — Beta-Oxidation, Ketogenesis, Lipoprotein Metabolism",
   common: ["Obesity/dyslipidemia", "Fatty liver disease"],
   lessCommon: ["Familial hypercholesterolemia"],
   rare: ["Tay-Sachs disease", "Niemann-Pick disease", "Gaucher's disease", "Fabry disease", "Zellweger syndrome"],
  },
  5: {
   title: "Protein Metabolism — Amino Acid Catabolism, Urea Cycle",
   common: ["Protein-energy malnutrition (Kwashiorkor/Marasmus)"],
   lessCommon: ["Phenylketonuria (PKU)", "Homocystinuria", "Maple syrup urine disease"],
   rare: ["Alkaptonuria", "Porphyrias (acute intermittent porphyria)", "Citrullinemia / urea cycle disorders"],
  },
  6: {
   title: "Nucleotide Metabolism — Purine and Pyrimidine Synthesis",
   common: ["Gout (hyperuricemia)"],
   lessCommon: [],
   rare: ["Lesch-Nyhan syndrome"],
  },
  7: {
   title: "Vitamins and Minerals — Deficiency Diseases and Functions",
   common: ["Vitamin D deficiency (rickets/osteomalacia)", "Iron deficiency anemia", "Vitamin B12 deficiency"],
   lessCommon: ["Wilson's disease", "Hemochromatosis"],
   rare: [],
  },
  8: {
   title: "Molecular Biology — DNA Replication, Transcription, Translation",
  ...
  10: {
   title: "Clinical Biochemistry — Liver Function, Kidney Function Tests",
   common: ["Hypothyroidism (biochemical basis)"],
   lessCommon: [],
   rare: [],
  },
 },
 "Pathology": {
  ...
  2: {
   title: "Inflammation — Acute and Chronic; Healing and Repair",
   common: ["Chronic inflammation-related fibrosis"],
   lessCommon: [],
   rare: [],
  },
  3: {
  ...
  4: {
   title: "Neoplasia — Benign and Malignant Tumours; Carcinogenesis",
   common: ["Benign prostatic hyperplasia", "Common carcinomas (breast, lung, cervix, oral)"],
   lessCommon: ["Hodgkin's and Non-Hodgkin's lymphoma", "Multiple myeloma", "Leukemias (acute and chronic)"],
   rare: ["Langerhans cell histiocytosis", "Castleman disease", "Mycosis fungoides", "Kaposi sarcoma", "Ewing's sarcoma", "Retinoblastoma", "Wilms tumor", "Burkitt lymphoma"],
  },
  5: {
   title: "Immunopathology — Hypersensitivity, Autoimmunity, Immunodeficiency",
   common: [],
   lessCommon: ["Amyloidosis", "Sarcoidosis", "Systemic lupus erythematosus", "Wegener's granulomatosis (GPA)", "Polyarteritis nodosa"],
   rare: ["Goodpasture syndrome"],
  },
  6: {
   title: "Infectious Diseases — Bacterial, Viral, Fungal, and Parasitic Pathology",
   common: ["Tuberculosis (pathology)"],
   lessCommon: [],
   rare: [],
  },
  7: {
   title: "Systemic Pathology — Cardiovascular System",
   common: ["Atherosclerosis", "Ischemic heart disease / myocardial infarction", "Rheumatic heart disease"],
   lessCommon: [],
   rare: [],
  },
  8: {
  ...
  9: {
   title: "Systemic Pathology — GIT, Liver, and Pancreas",
   common: ["Cirrhosis of liver"],
   lessCommon: [],
   rare: [],
  },
  10: {
   title: "Systemic Pathology — Kidney, Haematopoietic System, and Endocrine",
   common: ["Iron deficiency anemia (pathology)", "Chronic kidney disease"],
   lessCommon: ["Hemolytic anemias (autoimmune, hereditary spherocytosis)", "Nephrotic syndrome (minimal change, FSGS, membranous)"],
   rare: [],
  },
 },
 "Pharmacology": {
  1: {
   title: "General Pharmacology — Pharmacokinetics and Pharmacodynamics",
   common: [],
   lessCommon: ["Drug-induced hepatotoxicity", "Drug-induced lupus", "Stevens-Johnson syndrome / TEN (drug-induced)"],
   rare: ["Thalidomide-induced phocomelia", "Halothane hepatitis", "Fixed drug eruption (severe forms)", "Malignant hyperthermia (anesthetic drugs)", "Black cohosh/herbal drug-induced hepatotoxicity"],
  },
  2: {
   title: "Autonomic Nervous System Drugs — Cholinergic and Adrenergic",
   common: ["Bronchial asthma (pharmacotherapy)"],
   lessCommon: [],
   rare: ["Ergotism"],
  },
  3: {
   title: "Central Nervous System Drugs — Sedatives, Antipsychotics, Antidepressants",
   common: ["Depression (antidepressant pharmacology)", "Epilepsy (antiepileptic pharmacology)"],
   lessCommon: ["Serotonin syndrome", "Neuroleptic malignant syndrome"],
   rare: ["Lithium-induced nephrogenic diabetes insipidus"],
  },
  4: {
   title: "Cardiovascular Drugs — Antihypertensives, Antiarrhythmics, Diuretics",
   common: ["Hypertension (drug therapy contexts)"],
   lessCommon: ["Digoxin toxicity"],
   rare: [],
  },
  5: {
   title: "Autacoids and Anti-inflammatory Drugs — NSAIDs, Corticosteroids",
   common: ["Pain management contexts (NSAID use)", "Allergic rhinitis / anaphylaxis"],
   lessCommon: [],
   rare: ["Reye's syndrome (aspirin-associated)"],
  },
  6: {
   title: "Antimicrobial Agents — Antibiotics, Antifungals, Antivirals",
   common: ["Bacterial infections (antibiotic contexts)"],
   lessCommon: ["Aminoglycoside-induced ototoxicity/nephrotoxicity"],
   rare: ["Chloramphenicol-induced aplastic anemia / gray baby syndrome", "Isoniazid-induced peripheral neuropathy"],
  },
  7: {
   title: "Chemotherapy — Anticancer Drugs",
   common: [],
   lessCommon: ["Methotrexate toxicity"],
   rare: [],
  },
  8: {
   title: "Endocrine Pharmacology — Insulin, Thyroid, Sex Hormones",
   common: ["Type 2 diabetes (drug therapy)"],
   lessCommon: ["Steroid-induced Cushing's syndrome"],
   rare: [],
  },
  9: {
   title: "GIT Drugs — Antacids, Antiemetics, Laxatives",
   common: ["Peptic ulcer disease (drug-induced/treated)", "Drug-induced peptic ulcer/gastritis"],
   lessCommon: [],
   rare: [],
  },
  10: {
   title: "Haematological Drugs — Anticoagulants, Thrombolytics, Iron Therapy",
   common: [],
   lessCommon: ["Warfarin-induced bleeding/skin necrosis"],
   rare: [],
  },
 },
 "Microbiology": {
  ...
  4: {
   title: "Systemic Bacteriology — Gram-positive and Gram-negative Organisms",
   common: ["Typhoid fever", "Urinary tract infection (E. coli)", "Streptococcal pharyngitis", "Staphylococcal skin infections"],
   lessCommon: ["Leptospirosis", "Brucellosis", "Diphtheria", "Pertussis (whooping cough)", "Tetanus"],
   rare: ["Anthrax", "Plague (Yersinia pestis)", "Melioidosis", "Cholera (severe outbreak forms)", "Actinomycosis"],
  },
  5: {
   title: "Mycobacteriology — Tuberculosis and Leprosy",
   common: ["Tuberculosis"],
  ...
  6: {
   title: "Virology — DNA and RNA Viruses; HIV",
   common: ["Dengue fever", "Viral hepatitis (A, B, C)", "HIV/AIDS"],
   lessCommon: ["Rabies"],
   rare: ["Nipah virus infection", "Kyasanur Forest disease", "Chikungunya (severe complications)", "Prion diseases (Creutzfeldt-Jakob disease)"],
  },
  7: {
   title: "Mycology — Pathogenic Fungi and Antifungal Sensitivity",
   common: ["Fungal skin infections (dermatophytosis, candidiasis)"],
   lessCommon: ["Cryptococcal meningitis", "Mucormycosis"],
   rare: ["Histoplasmosis"],
  },
  8: {
   title: "Parasitology — Protozoa, Helminths, Arthropods",
   common: ["Malaria"],
   lessCommon: ["Amoebiasis", "Giardiasis"],
   rare: [],
  },
  9: {
   title: "Clinical Microbiology — Specimen Collection and Interpretation",
 ...
 "Forensic Medicine & Toxicology": {
  1: {
   ...
   common: [],
   lessCommon: [],
   rare: ["Munchausen syndrome by proxy", "Fetal death/infanticide medicolegal cases"],
  },
  2: {
   title: "Death and Post-mortem Changes — Time Since Death",
   common: [],
  ...
  4: {
   title: "Injuries — Mechanical, Thermal, Chemical, and Electrical",
   common: ["Road traffic accident-related injuries", "Burns (medicolegal aspects)", "Firearm injuries (medicolegal)", "Drowning", "Hanging/asphyxial deaths", "Domestic violence-related injuries"],
   lessCommon: ["Electrocution injuries", "Heat stroke (medicolegal)"],
   rare: ["Radiation injury"],
  },
  5: {
   title: "Sexual Offences — Examination and Evidence Collection",
   common: [],
   lessCommon: ["Sexual assault-related injury patterns"],
   rare: [],
  },
  6: {
   title: "Identification — Age, Sex, Stature, Fingerprints",
  ...
  7: {
   title: "General Toxicology — Absorption, Distribution, Elimination of Poisons",
   common: [],
   lessCommon: ["Kerosene/hydrocarbon poisoning", "Rodenticide (zinc phosphide) poisoning", "Carbon monoxide poisoning", "Aluminium phosphide poisoning"],
   rare: ["Arsenic poisoning (chronic)", "Lead poisoning (medicolegal)", "Mercury poisoning", "Thallium poisoning", "Cyanide poisoning", "Mushroom poisoning"],
  },
  8: {
   title: "Corrosive and Irritant Poisons",
   common: ["Corrosive/acid poisoning"],
   lessCommon: [],
   rare: [],
  },
  9: {
   title: "Neurological Poisons — Narcotics, Sedatives, Organophosphates",
   common: ["Organophosphate poisoning", "Snake bite (venomous)"],
   lessCommon: ["Barbiturate/benzodiazepine poisoning", "Opioid overdose", "Scorpion sting"],
   rare: ["Puffer fish (tetrodotoxin) poisoning"],
  },
  10: {
   title: "Medicolegal Aspects of Substance Abuse and Alcohol",
   common: ["Alcohol intoxication/dependence"],
   lessCommon: [],
   rare: [],
  },
 },
 "Community Medicine": {
  ...
  4: {
   title: "Environment and Health — Water, Air, Food, Housing",
   common: [],
   lessCommon: ["Fluorosis"],
   rare: ["Endemic fluorosis-related skeletal deformity", "Minamata disease (mercury, environmental)"],
  },
  5: {
   title: "Nutrition and Health — Assessment, Deficiency Diseases, Programmes",
   common: ["Malnutrition (PEM, stunting, wasting)", "Anemia (public health burden)"],
   lessCommon: ["Iodine deficiency disorders (goiter)", "Vitamin A deficiency (xerophthalmia)"],
   rare: [],
  },
  6: {
   title: "Communicable Disease Control — Immunisation, Surveillance",
   common: ["Diarrheal diseases (childhood)", "Acute respiratory infections (childhood)", "Tuberculosis (public health)", "Vaccine-preventable diseases (measles, polio)", "Vector-borne diseases (malaria, dengue, filariasis)"],
   lessCommon: ["Leprosy (public health control)", "HIV/AIDS (epidemiological)", "Lymphatic filariasis", "Japanese encephalitis", "Rabies (public health control)"],
   rare: ["Guinea worm disease (dracunculiasis) — near eradicated", "Yaws", "Trachoma (blinding)", "Kala-azar (visceral leishmaniasis)", "Cholera outbreaks", "Nipah virus outbreaks"],
  },
  7: {
   title: "Non-communicable Diseases — Cardiovascular, Cancer, Diabetes",
   common: ["Hypertension (population screening)", "Diabetes (population screening)"],
   lessCommon: ["Tobacco-related diseases (population level)"],
   rare: [],
  },
  8: {
   title: "Maternal and Child Health — Reproductive and Child Health Programme",
   common: ["Maternal mortality-related conditions"],
   lessCommon: [],
   rare: [],
  },
  9: {
  ...
  10: {
   title: "Occupational Health and Disaster Management",
   common: [],
   lessCommon: ["Occupational lung diseases (silicosis, byssinosis)"],
   rare: ["Anthrax (occupational/zoonotic)", "Radiation exposure disorders"],
  },
 },
 "Ophthalmology": {
  1: {
  ...
  2: {
   title: "Diseases of the Conjunctiva — Conjunctivitis, Trachoma",
   common: ["Conjunctivitis (bacterial/viral/allergic)", "Trachoma", "Stye (hordeolum)", "Chalazion"],
   lessCommon: [],
   rare: [],
  },
  3: {
   title: "Diseases of the Cornea and Sclera",
   common: ["Dry eye disease", "Pterygium", "Corneal abrasion/foreign body"],
   lessCommon: ["Keratoconus", "Corneal ulcer (bacterial/fungal)"],
   rare: ["Fuchs' endothelial dystrophy"],
  },
  4: {
   title: "Diseases of the Uveal Tract — Uveitis",
   common: [],
   lessCommon: ["Uveitis"],
   rare: ["Sympathetic ophthalmia", "Choroidal melanoma", "Behçet's disease (ocular involvement)"],
  },
  5: {
   title: "Glaucoma — Types, Diagnosis, and Management",
   common: [],
   lessCommon: ["Glaucoma (primary open angle, angle closure)"],
   rare: ["Congenital glaucoma (buphthalmos)"],
  },
  6: {
   title: "Diseases of the Lens — Cataract",
   common: ["Cataract"],
   lessCommon: [],
   rare: ["Marfan syndrome-related lens dislocation"],
  },
  7: {
   title: "Diseases of the Retina — Diabetic Retinopathy, Detachment",
   common: ["Diabetic retinopathy"],
   lessCommon: ["Retinal detachment", "Central retinal artery/vein occlusion", "Optic neuritis", "Hypertensive retinopathy"],
   rare: ["Retinoblastoma", "Retinitis pigmentosa", "Coats disease"],
  },
  8: {
   title: "Disorders of Ocular Motility — Squint and Amblyopia",
   common: [],
   lessCommon: ["Squint (strabismus)"],
   rare: [],
  },
  9: {
   title: "Refractive Errors and Low Vision",
  ...
  10: {
   title: "Ophthalmic Emergencies and Surgical Procedures",
   common: [],
   lessCommon: ["Endophthalmitis"],
   rare: ["Orbital cellulitis (severe complications)"],
  },
 },
 "Otorhinolaryngology (ENT)": {
  ...
  2: {
   title: "Diseases of the External and Middle Ear",
   common: ["Otitis media (acute/chronic)", "Wax impaction (cerumen)", "Foreign body in ear/nose"],
   lessCommon: ["Mastoiditis"],
   rare: ["Cholesteatoma (complicated)", "Ramsay Hunt syndrome", "Necrotizing (malignant) otitis externa"],
  },
  3: {
   title: "Sensorineural Hearing Loss and Tinnitus",
   common: ["Hearing loss (conductive/sensorineural, age-related)"],
   lessCommon: ["Ménière's disease", "Vestibular neuronitis", "Sudden sensorineural hearing loss"],
   rare: ["Acoustic neuroma"],
  },
  4: {
   title: "Otosclerosis and Otological Surgeries",
   common: [],
   lessCommon: ["Otosclerosis"],
   rare: [],
  },
  5: {
   title: "Diseases of the Nose and Paranasal Sinuses",
   common: ["Sinusitis", "Allergic rhinitis", "Deviated nasal septum"],
   lessCommon: ["Nasal polyposis"],
   rare: ["Wegener's granulomatosis (ENT presentation)", "Rhinoscleroma"],
  },
  6: {
   title: "Epistaxis — Causes and Management",
   common: ["Epistaxis"],
  ...
  7: {
   title: "Diseases of the Pharynx and Tonsils",
   common: ["Tonsillitis/pharyngitis"],
   lessCommon: ["Peritonsillar abscess (quinsy)", "Adenoid hypertrophy"],
   rare: [],
  },
  8: {
   title: "Diseases of the Larynx — Hoarseness, Croup, Cancer",
   common: ["Laryngitis"],
   lessCommon: ["Vocal cord nodules/polyps", "Laryngeal papillomatosis"],
   rare: ["Laryngeal carcinoma"],
  },
  9: {
   title: "Tracheostomy — Indications and Technique",
   common: [],
  ...
  10: {
   ...
   common: [],
   lessCommon: [],
   rare: ["Nasopharyngeal carcinoma", "Juvenile angiofibroma", "Glomus jugulare tumor"],
  },
 },
 "General Medicine": {
  1: {
   title: "Cardiovascular Diseases — IHD, Heart Failure, Hypertension",
   common: ["Hypertension", "Ischemic heart disease"],
   lessCommon: ["Congestive heart failure"],
   rare: [],
  },
  2: {
   title: "Respiratory Diseases — Pneumonia, COPD, Asthma, TB",
   common: ["Chronic obstructive pulmonary disease (COPD)", "Bronchial asthma", "Community-acquired pneumonia", "Pulmonary tuberculosis"],
   lessCommon: [],
   rare: [],
  },
  3: {
   title: "Gastrointestinal Diseases — Peptic Ulcer, IBD, Liver Diseases",
   common: ["Peptic ulcer disease / GERD"],
   lessCommon: ["Chronic liver disease/cirrhosis"],
   rare: ["Wilson's disease (clinical)", "Hemochromatosis (clinical)"],
  },
  4: {
   title: "Renal Diseases — Nephritis, Nephrotic Syndrome, CKD",
   common: ["Chronic kidney disease"],
   lessCommon: ["Nephrotic/nephritic syndrome"],
   rare: [],
  },
  5: {
   title: "Endocrine Disorders — Diabetes Mellitus, Thyroid, Adrenal",
   common: ["Type 2 diabetes mellitus"],
   lessCommon: ["Hypothyroidism/hyperthyroidism"],
   rare: ["Addison's disease", "Pheochromocytoma"],
  },
  6: {
   title: "Neurological Disorders — Stroke, Epilepsy, Meningitis",
   common: [],
   lessCommon: ["Stroke (ischemic/hemorrhagic)"],
   rare: ["Guillain-Barré syndrome", "Myasthenia gravis"],
  },
  7: {
   title: "Infectious Diseases — Malaria, Typhoid, Dengue, HIV/AIDS",
   common: [],
   lessCommon: ["Malaria (complicated)", "Dengue (with warning signs)", "Enteric (typhoid) fever with complications"],
   rare: ["HIV/AIDS with opportunistic infections"],
  },
  8: {
   title: "Haematological Disorders — Anaemia, Leukaemia, Coagulopathy",
   common: ["Anemia (iron deficiency)"],
   lessCommon: [],
   rare: ["Amyloidosis (systemic)", "Thrombotic thrombocytopenic purpura"],
  },
  9: {
   title: "Rheumatological Disorders — Rheumatoid Arthritis, SLE",
   common: [],
   lessCommon: ["Rheumatoid arthritis", "Systemic lupus erythematosus"],
   rare: ["Systemic sclerosis (scleroderma)"],
  },
  10: {
   title: "Clinical Skills — History Taking, Examination, ECG, Radiology",
   common: [],
 ...
 "General Surgery": {
  1: {
   title: "Wounds, Wound Healing, and Surgical Infections",
   common: ["Wound infections/abscess", "Varicose veins (surgical)"],
   lessCommon: ["Diabetic foot/gangrene", "Peripheral arterial disease"],
  ...
  4: {
   title: "Trauma — Polytrauma, Burns, and Fracture Management",
   common: [],
   lessCommon: ["Splenic injury/rupture"],
   rare: [],
  },
  5: {
   title: "Principles of Anaesthesia and Pre-operative Assessment",
  ...
  6: {
   title: "Diseases of the Breast",
   common: ["Breast lump (fibroadenoma/carcinoma workup)"],
   lessCommon: [],
   rare: [],
  },
  7: {
   title: "Diseases of the Thyroid and Parathyroid",
   common: ["Thyroid nodule/goiter"],
   lessCommon: ["Thyroid carcinoma"],
   rare: [],
  },
  8: {
   title: "Abdominal Surgery — Appendix, Intestine, Hernia, Peritonitis",
   common: ["Acute appendicitis", "Inguinal hernia", "Hemorrhoids", "Peptic ulcer perforation", "Intestinal obstruction"],
   lessCommon: ["Perianal fistula", "Umbilical/incisional hernia"],
   rare: ["Zollinger-Ellison syndrome", "Boerhaave syndrome (esophageal rupture)", "Meckel's diverticulitis", "Volvulus (sigmoid/cecal)"],
  },
  9: {
   title: "Hepatobiliary and Pancreatic Surgery",
   common: ["Gallstone disease/cholecystitis"],
   lessCommon: ["Acute pancreatitis", "Hydatid cyst (liver)"],
   rare: ["Pancreatic pseudocyst with complications"],
  },
  10: {
   title: "Surgical Oncology and Transplant Surgery Principles",
   common: [],
   lessCommon: ["Carcinoma stomach", "Carcinoma colon/rectum"],
   rare: ["Carcinoid tumor", "Gastrointestinal stromal tumor (GIST)", "Pheochromocytoma (surgical)", "Retroperitoneal sarcoma"],
  },
 },
 "Obstetrics & Gynaecology (OBG)": {
  ...
  2: {
   title: "Normal Pregnancy — Diagnosis, Antenatal Care, Fetal Development",
   common: ["Normal pregnancy/antenatal care conditions", "Anemia in pregnancy", "Gestational diabetes"],
   lessCommon: [],
   rare: [],
  },
  3: {
  ...
  4: {
   title: "Abnormal Labour — Dystocia, Obstructed Labour",
   common: [],
   lessCommon: ["Obstructed labour"],
   rare: ["Uterine rupture"],
  },
  5: {
   title: "Obstetric Complications — APH, PPH, Pre-eclampsia, Eclampsia",
   common: ["Pregnancy-induced hypertension/pre-eclampsia", "Postpartum hemorrhage", "Ectopic pregnancy"],
   lessCommon: ["Eclampsia", "Placenta previa", "Abruptio placentae", "Rh isoimmunization"],
   rare: ["Amniotic fluid embolism", "Vasa previa", "HELLP syndrome", "Uterine inversion", "Placenta accreta/percreta"],
  },
  6: {
   title: "Operative Obstetrics — Forceps, Vacuum, Caesarean Section",
   common: [],
  ...
  8: {
   title: "Gynaecological Disorders — Menstrual Disorders, Fibroids, PCOS",
   common: ["Menstrual disorders (menorrhagia, dysmenorrhea)", "Polycystic ovarian syndrome (PCOS)", "Uterine fibroids"],
   lessCommon: ["Ovarian cysts/tumors (benign)", "Endometriosis", "Infertility (female factor)"],
   rare: ["Asherman's syndrome"],
  },
  9: {
   title: "Infections of the Female Genital Tract",
   common: ["Vaginal/pelvic infections"],
   lessCommon: [],
   rare: [],
  },
  10: {
   title: "Gynaecological Oncology and Family Planning",
   common: [],
   lessCommon: ["Cervical intraepithelial neoplasia", "Molar pregnancy (hydatidiform mole)"],
   rare: ["Choriocarcinoma", "Ovarian carcinoma", "Cervical carcinoma (advanced)"],
  },
 },
 "Paediatrics": {
  1: {
  ...
  2: {
   title: "Neonatology — Care of Newborn, LBW, Prematurity, Birth Asphyxia",
   common: ["Neonatal jaundice"],
   lessCommon: ["Congenital heart disease", "Neonatal sepsis", "Respiratory distress syndrome (preterm)"],
   rare: ["Biliary atresia"],
  },
  3: {
   title: "Infant Feeding and Nutritional Disorders",
   common: ["Protein-energy malnutrition", "Vitamin D deficiency rickets"],
   lessCommon: [],
   rare: [],
  },
  4: {
   title: "Immunisation Schedule and Vaccine-preventable Diseases",
   common: ["Vaccine-preventable diseases (measles, chickenpox)"],
   lessCommon: [],
   rare: [],
  },
  5: {
   title: "Respiratory Disorders in Children — Pneumonia, Bronchiolitis, Asthma",
   common: ["Acute respiratory infections", "Bronchiolitis"],
   lessCommon: [],
   rare: [],
  },
  6: {
   title: "Gastrointestinal Disorders — Diarrhoea, Dehydration, Malabsorption",
   common: ["Acute diarrheal disease/dehydration", "Worm infestations"],
   lessCommon: [],
  ...
  7: {
   title: "Paediatric Infections — Measles, Chickenpox, Meningitis, Typhoid",
   common: [],
   lessCommon: ["Acute rheumatic fever"],
   rare: ["Kawasaki disease", "Reye's syndrome"],
  },
  8: {
   title: "Genetic and Chromosomal Disorders",
   common: [],
   lessCommon: ["Down syndrome"],
   rare: ["Duchenne muscular dystrophy", "Congenital adrenal hyperplasia", "SCID (severe combined immunodeficiency)"],
  },
  9: {
   title: "Haematological and Oncological Conditions in Children",
   common: ["Iron deficiency anemia"],
   lessCommon: ["Thalassemia"],
   rare: ["Acute lymphoblastic leukemia", "Wilms tumor", "Neuroblastoma"],
  },
  10: {
   title: "Paediatric Emergencies and Developmental Paediatrics",
   common: ["Febrile seizures"],
   lessCommon: ["Nephrotic syndrome (childhood)", "Cerebral palsy", "Autism spectrum disorder", "ADHD"],
   rare: [],
  },
 },
 "Orthopaedics": {
  1: {
   title: "Fractures — Classification, Healing, and Principles of Management",
   common: ["Fractures (long bone — femur, tibia, radius/ulna)", "Sprains and ligament injuries", "Osteoporosis"],
   lessCommon: [],
   rare: [],
  },
  2: {
   title: "Fractures of Upper Limb",
   common: ["Fracture clavicle", "Frozen shoulder"],
   lessCommon: [],
   rare: [],
  },
  3: {
   title: "Fractures of Lower Limb",
   common: ["Plantar fasciitis"],
   lessCommon: ["Avascular necrosis of femoral head", "Compartment syndrome"],
   rare: [],
  },
  4: {
   title: "Dislocations — Shoulder, Hip, Knee, and Other Joints",
   common: ["Dislocation shoulder"],
   lessCommon: [],
   rare: [],
  },
  5: {
   title: "Spine — Disc Prolapse, Spinal Injuries, Deformities",
   common: ["Low back pain / disc prolapse", "Cervical spondylosis"],
   lessCommon: ["Scoliosis"],
   rare: [],
  },
  6: {
   title: "Bone Infections — Osteomyelitis and Septic Arthritis",
   common: [],
   lessCommon: ["Osteomyelitis", "Septic arthritis"],
   rare: [],
  },
  7: {
   title: "Bone Tumours — Benign and Malignant",
   common: [],
   lessCommon: [],
   rare: ["Osteosarcoma", "Ewing's sarcoma", "Paget's disease of bone", "Giant cell tumor of bone", "Chondrosarcoma", "Fibrous dysplasia"],
  },
  8: {
   title: "Arthritis — Osteoarthritis, Rheumatoid, Gout",
   common: ["Osteoarthritis"],
   lessCommon: ["Rheumatoid arthritis (orthopaedic aspects)", "Ankylosing spondylitis"],
   rare: [],
  },
  9: {
   title: "Congenital and Developmental Disorders — CTEV, DDH, CDH",
   common: [],
   lessCommon: ["Congenital talipes equinovarus (CTEV/clubfoot)", "Developmental dysplasia of hip (DDH)", "Rickets/osteomalacia (orthopaedic)"],
   rare: ["Osteogenesis imperfecta", "Achondroplasia", "Perthes disease", "Marfan syndrome (skeletal)"],
  },
  10: {
   title: "Orthopaedic Surgeries — Arthroplasty, Arthroscopy, Amputation",
   common: [],
 ...
 "Dermatology": {
  1: {
   ...
   common: [],
   lessCommon: [],
   rare: ["Epidermolysis bullosa"],
  },
  2: {
   title: "Approach to a Skin Patient — Lesion Morphology and Terminology",
   common: ["Vitiligo", "Alopecia (androgenetic/areata)"],
   lessCommon: ["Melasma"],
   rare: ["Necrobiosis lipoidica"],
  },
  3: {
   title: "Eczema and Dermatitis — Atopic, Contact, Seborrhoeic",
   common: ["Eczema/atopic dermatitis", "Contact dermatitis"],
   lessCommon: ["Seborrheic dermatitis"],
   rare: [],
  },
  4: {
   title: "Psoriasis and Papulosquamous Disorders",
   common: ["Psoriasis"],
   lessCommon: ["Lichen planus"],
   rare: [],
  },
  5: {
   title: "Acne Vulgaris and Rosacea",
  ...
  6: {
   title: "Skin Infections — Bacterial, Fungal, and Viral",
   common: ["Fungal skin infections (tinea)", "Scabies", "Viral warts"],
   lessCommon: ["Herpes zoster"],
   rare: [],
  },
  7: {
   title: "Sexually Transmitted Infections — Syphilis, Gonorrhoea, Herpes",
   common: [],
   lessCommon: ["Syphilis (cutaneous manifestations)"],
   rare: [],
  },
  8: {
   title: "Leprosy — Classification, Treatment, Reactions",
   common: [],
   lessCommon: ["Leprosy (dermatological)"],
   rare: [],
  },
  9: {
   title: "Skin Tumours — BCC, SCC, Melanoma",
   common: [],
   lessCommon: [],
   rare: ["Mycosis fungoides", "Xeroderma pigmentosum", "Cutaneous T-cell lymphoma", "Acanthosis nigricans (paraneoplastic)"],
  },
  10: {
   title: "Drug Reactions and Dermatological Emergencies",
   common: ["Urticaria"],
   lessCommon: ["Pemphigus vulgaris", "Bullous pemphigoid", "Drug eruptions (fixed drug eruption, Stevens-Johnson)"],
   rare: ["Toxic epidermal necrolysis", "Dermatitis herpetiformis", "Pyoderma gangrenosum", "Sweet syndrome"],
  },
 },
 "Psychiatry": {
  1: {
  ...
  2: {
   title: "Schizophrenia and Other Psychotic Disorders",
   common: [],
   lessCommon: ["Schizophrenia"],
   rare: ["Catatonia", "Schizoaffective disorder", "Capgras syndrome", "Cotard's syndrome", "Folie à deux (shared psychotic disorder)", "De Clerambault syndrome (erotomania)"],
  },
  3: {
   title: "Mood Disorders — Depression and Bipolar Disorder",
   common: ["Major depressive disorder"],
   lessCommon: ["Bipolar affective disorder"],
   rare: [],
  },
  4: {
   title: "Anxiety Disorders — Phobias, OCD, PTSD, Panic Disorder",
   common: ["Generalized anxiety disorder", "Somatoform disorders", "Panic disorder", "Adjustment disorder", "Post-traumatic stress disorder", "Obsessive-compulsive disorder"],
   lessCommon: ["Social anxiety disorder / phobias", "Somatic symptom disorder", "Conversion disorder"],
   rare: ["Dissociative identity disorder"],
  },
  5: {
   title: "Substance Use Disorders — Alcohol, Drugs, Tobacco Dependence",
   common: ["Alcohol use disorder", "Substance use disorder (tobacco/cannabis)"],
   lessCommon: ["Opioid dependence"],
   rare: [],
  },
  6: {
   title: "Organic Mental Disorders — Delirium, Dementia",
   common: [],
   lessCommon: ["Delirium", "Dementia (Alzheimer's type)"],
   rare: ["Kleine-Levin syndrome"],
  },
  7: {
   title: "Personality Disorders",
   common: [],
   lessCommon: ["Personality disorders (borderline, antisocial)"],
   rare: [],
  },
  8: {
   title: "Child and Adolescent Psychiatry — ADHD, Autism, Learning Disorders",
   common: [],
   lessCommon: ["ADHD (psychiatric evaluation)"],
   rare: [],
  },
  9: {
   title: "Psychiatric Emergencies — Suicidality, Aggression, Acute Psychosis",
  ...
  10: {
   ...
   common: [],
   lessCommon: [],
   rare: ["Neuroleptic malignant syndrome (psychiatric context)"],
  },
 },
 "Emergency Medicine": {
  1: {
  ...
  2: {
   title: "Airway Management — BVM, Intubation, Surgical Airway",
   common: ["Acute severe asthma"],
   lessCommon: [],
   rare: [],
  },
  3: {
   title: "Cardiopulmonary Resuscitation (CPR) and ACLS",
   common: ["Acute myocardial infarction", "Acute stroke", "Status epilepticus"],
   lessCommon: ["Cardiac arrest (arrhythmia-related)"],
   rare: [],
  },
  4: {
   title: "Shock Management — Fluid Resuscitation Protocols",
   common: ["Anaphylaxis", "Diabetic ketoacidosis", "Acute gastroenteritis with dehydration"],
   lessCommon: ["Septic shock", "Hypoglycemic emergency", "Acute pulmonary edema", "Ectopic pregnancy rupture (emergency)", "Acute abdomen (perforation/obstruction)"],
   rare: ["Massive pulmonary embolism", "Aortic dissection", "Amniotic fluid embolism (emergency)", "Thyroid storm", "Myxedema coma", "Addisonian crisis", "Malignant hyperthermia (emergency)", "Neuroleptic malignant syndrome (emergency)"],
  },
  5: {
   title: "Polytrauma — Primary and Secondary Survey (ATLS Approach)",
   common: ["Trauma/polytrauma"],
   lessCommon: ["Tension pneumothorax"],
   rare: [],
  },
  6: {
   title: "Burns — Assessment, Resuscitation, and Wound Care",
   common: [],
   lessCommon: ["Burns (major)"],
   rare: [],
  },
  7: {
   title: "Toxicological Emergencies — Poisoning and Overdose",
   common: ["Acute poisoning (organophosphate, drug overdose)", "Snake bite envenomation"],
   lessCommon: [],
   rare: [],
  },
  8: {
   title: "Environmental Emergencies — Heat Stroke, Hypothermia, Drowning",
   common: [],
   lessCommon: ["Heat stroke", "Near-drowning"],
   rare: ["Electrical injury with cardiac arrest"],
  },
  9: {
   title: "Paediatric Emergencies — Febrile Seizures, Croup, Anaphylaxis",
   common: [],
  ...
  10: {
   ...
   common: [],
   lessCommon: [],
   rare: ["Mass casualty/disaster trauma"],
  },
 },
};
